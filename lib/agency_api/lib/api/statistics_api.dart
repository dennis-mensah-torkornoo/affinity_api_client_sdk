...
class StatisticsApi {
  ...
  Future<StatisticsResponse> getStatistics() async {
    ...
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'StatisticsResponse',) as StatisticsResponse;
    
    }
    return Future<StatisticsResponse>.value();
  }
}
